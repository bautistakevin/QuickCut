...
namespace QuickCut.CoreUI.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ServicesController(QuickCutDataDbContext context)
        {
            _context = context;
        }
        ...
        {
            var quickCutDataDbContext = _context.Services.Include(s => s.Barber);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BarberId,ServiceTitle,ServiceDescription")] Services services)
        {
            if (id != services.BarberId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ServicesExists(services.BarberId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Services.Any(e => e.BarberId == id);
        }
    }
}
